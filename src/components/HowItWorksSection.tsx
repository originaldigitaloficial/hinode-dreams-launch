  ...
  const steps = [
    {
      ...
      description: "Faça seu cadastro sem nenhum custo e torne-se um representante oficial da Hinode.",
      icon: "👤"
    },
    {
      number: "02", 
      title: "Receba Treinamento",
      description: "Tenha acesso a materiais exclusivos e treinamentos para vender com sucesso.",
      icon: "📚"
    },
    {
      number: "03",
      title: "Comece a Vender",
      description: "Divulgue os produtos através das suas redes sociais e para amigos e família.",
      icon: "📱"
    },
    {
      number: "04",
      title: "Receba Comissões",
      description: "Ganhe comissões de até 35% sobre suas vendas e ainda mais com seu time.",
      icon: "💰"
    }
  ];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-hinode-navy mb-3 md:mb-4 animate-fade-in">
            Como Funciona para ser Representante Hinode
          </h2>
          <p className="text-base md:text-lg text-hinode-navy/80 max-w-2xl mx-auto animate-fade-in">
            Descubra como é simples começar sua jornada empreendedora com a Hinode e transformar sua vida financeira.
          </p>
        </div>
        ...
        <div className="mt-10 md:mt-12 lg:mt-16 text-center">
          <div className="bg-hinode-primary/10 rounded-2xl p-6 md:p-8 max-w-4xl mx-auto">
            ...
            <p className="text-base md:text-lg text-hinode-navy/80 mb-6">
              Não perca tempo! Milhares de pessoas já estão construindo sua independência financeira com a Hinode. 
              Seja você o próximo a transformar sua vida!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="flex items-center text-hinode-navy/70">
                <span className="text-green-500 mr-2">✓</span>
                <span className="text-sm md:text-base">Sem investimento inicial</span>
              </div>
              <div className="flex items-center text-hinode-navy/70">
                <span className="text-green-500 mr-2">✓</span>
                <span className="text-sm md:text-base">Trabalhe no seu tempo</span>
              </div>
              <div className="flex items-center text-hinode-navy/70">
                <span className="text-green-500 mr-2">✓</span>
                <span className="text-sm md:text-base">Renda extra garantida</span>
              </div>
            </div>
          </div>
        </div>
